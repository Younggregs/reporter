...
import editCategory from '../promises/EditCategory'
import deleteCategory from '../promises/DeleteCategory'
...
export default function UserItem(props) {
  ...
  const [category, setCategory] = React.useState(props.item.name);
...
const handleEdit = async (id) => {
  ...
  setOpenedit(false)
  setOpenalert(true)
  setAlertmsg('Submitting Category')

  const message = await editCategory(id, category)
  setOpenalert(true)
  if(message.error_message){
    ...
    setEdited(true);
    setBrick(message);
    setAlertmsg('Category edited succesfully')
    //setLink(message)
  }
...
const handleDelete = async (id) => {
  ...
  if(message.error_message){
    ...
    setDeleted(true)
    setAlertmsg('Category deleted succesfully')
  }
      ...
      <Paper elevation={3} square style={{marginBottom: 10, borderBottom: '10px solid green'}}>
        ...
        <Grid>
            {edited ? (
                ...
                <Dialog fullWidth={true} maxWidth={'sm'} open={opendelete} onClose={handleCloseDelete} aria-labelledby="form-dialog-delete">
                    <DialogTitle id="form-dialog-title">
                      <p>Are you sure you want to delete this Incident Category? {brick.name}</p>
                      <p>All Reports with this Incident Category would be deleted</p>
            ...
            <Button onClick={handleClickOpenEdit}>
              ...
              <Dialog fullWidth={true} maxWidth={'sm'} open={openedit} onClose={handleCloseEdit} aria-labelledby="form-dialog-edit">
                  <DialogTitle id="form-dialog-title">Edit Incident Category</DialogTitle>
                  <DialogContent>
                  <DialogContentText>
                      It's all about the network.
                  </DialogContentText>
